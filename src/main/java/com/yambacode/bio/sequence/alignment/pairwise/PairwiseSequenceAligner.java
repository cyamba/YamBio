...
public interface PairwiseSequenceAligner extends SequenceAligner<PairwiseAlignmentInput, PairwiseAlignmentResult> {
    PairwiseAlignmentResult align(PairwiseAlignmentInput input);
